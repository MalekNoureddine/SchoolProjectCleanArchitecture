...
namespace CleanArchProject.Service.Interfaces
{
    public interface ISubjectService
    {
        ...
        public Task<bool> IsSubjectNameExists(string subjectName);
        public Task<bool> IsSubjectArabicNameExists(string subjectArabicName);
        public Task<bool> IsSubjectArabicNameExistsById(string subjectArabicName, int Id);
        public Task<bool> IsSubjectNameExistsById(string subjectName, int Id);
